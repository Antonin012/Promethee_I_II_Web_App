...
class ApiE2ETest {
    ...
    void setup() {
        ...
        // Check if the server is reachable. If not, skip these tests.
        boolean serverUp = isServerReachable();
        Assumptions.assumeTrue(serverUp, "E2E Tests skipped: Server is not running on " + BASE_URL);
    }
