...
\begin{itemize}
    \item \textbf{Unit Testing:} The core mathematical engine (\texttt{PrometheeCalcul} and preference functions) is heavily tested to guarantee that the PROMETHEE flows and calculations are strictly accurate.
